   ...
   <main>
       <form action="/exam/store" method="POST" enctype="multipart/form-data">
         <div class="form d-flex flex-column gap-3 px-4 py-4 bg-white rounded w-50 mx-auto mt-5">
            <h1 class="fs-4 fw-bold mb-2 align-self-center  text-primary">انشاء اختبار جديد</h1>
            <input type="hidden" name="week_id" value="<?= $courseExam['week_id'] ?>">

            <p class="error error-exam text-danger mb-0 ms-2"><?= $errors['week_id'] ?? '' ?></p>
            <div class="col-12">
                <input type="text" name="title" value="<?= old('title') ?>" class="form-control input mb-2" placeholder="عنوان الاختبار" required>
            ...
            <div class="col-12">
                <textarea type="text" name="description" class="form-control textarea" placeholder="الوصف او تعليمات الاختبار" required><?= old('description') ?></textarea>

                <p class="error error-exam text-danger mb-0 ms-2" data-error-for="description"><?= $errors['description'] ?? '' ?></p>
            </div>

            <label class="form-label text-primary fw-bold mb-0">ملف الاختبار</label>
            <input 
                 type="file"
                 name="url"
                 class="form-control"
            ...
            <p class="error error-exam text-danger mb-0 ms-2"><?= $errors['url'] ?? '' ?></p>
            ...
            <input 
                 ...
                 placeholder="علامة الطالب / الدرجة الكاملة "
                 required />
            ...
            <div class="d-flex flex-row gap-2 mt-2">
                <div class="col-md-6">
                    ...
                    <input type="datetime-local" name="start_at" value="<?= old('start_at') ?>" class="form-control" id="start_at" required>
                ...
                <div class="col-md-6">
                    ...
                    <input type="datetime-local" value="<?= old('end_at') ?>" name="end_at" class="form-control" id="end_at" required>
