   ...
   <main>
     <form action="/week/store" method="POST">
        <div class="form d-flex flex-column gap-3 px-4 py-5 bg-white rounded w-50 mx-auto mt-5">
          <h1 class="fs-4 fw-bold mb-4 align-self-center text-primary">انشاء الاسبوع للمادة</h1>
          ...
          type="date"
                name="start_date"
                value="<?= old('start_date', "2026-01-01") ?>" 
