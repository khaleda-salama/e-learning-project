...
<body class="bg-body-tertiary">
  <?php require base_path('views/partials/nav.php') ?>
   <main>
     <form action="/semster/store" method="POST">
        <div class="form d-flex flex-column gap-3 px-4 py-5 bg-white rounded w-50 mx-auto mt-5">
          <h1 class="fs-4 fw-bold mb-4 align-self-center  text-primary">انشاء الفصل الدراسي</h1>
          <textarea 
          ...
          <button class="btn btn-primary mt-2 fs-5" type="submit">تأكيد</button>
