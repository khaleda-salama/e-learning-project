...
App::resolve(Database::class)->query('INSERT INTO courses (name, instructor_id, hour_num, level_year, major_id, semster_id) VALUES (:name, :instructor_id, :hour_num, :level_year, :major_id, :semster_id)', [    
